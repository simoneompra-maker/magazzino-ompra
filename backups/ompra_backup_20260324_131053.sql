...
\restrict 7oHTcENLlDguIXhsxaUKAeBLQuDpnJUwxpMprzuNVjDvElySZsU0K8EkZtfEc08
...
SELECT pg_catalog.setval('public.inventory_id_seq', 372, true);
...
SELECT pg_catalog.setval('realtime.subscription_id_seq', 4579, true);
...
\unrestrict 7oHTcENLlDguIXhsxaUKAeBLQuDpnJUwxpMprzuNVjDvElySZsU0K8EkZtfEc08
